package com.example.looknews.ui.news.model;

import android.util.Log;


import com.example.looknews.bean.NewsGson;
import com.example.looknews.constant.AppConfig;
import com.example.looknews.constant.TypeUrl;
import com.example.looknews.retrofit.ApiService;
import com.example.looknews.retrofit.RetrofitWrapper;
                ...
                .map(new Func1<NewsGson, List<NewsGson.NewslistBean>>() {
                    ...
                    public List<NewsGson.NewslistBean> call(NewsGson newsgson) { //
                        ...
                        for (NewsGson.NewslistBean newslistBean : newsgson.getNewslist()) {
                            ...
                            new1.setPicUrl(newslistBean.getPicUrl().replace("ss",""));
